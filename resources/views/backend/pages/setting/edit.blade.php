                ...
                <div class="panel-body">
                    ...
                    <form class="tocify-content" action="{{route('backend.subcategory.update',$category->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="terms_and_conditions_ar">{{trans('backend.setting.terms_and_conditions')}}</label>
                        ...
                        <div class="form-group">
                            <label for="terms_and_conditions_en">{{trans('backend.setting.terms_and_conditions')}}</label>
                        ...
                        <div class="form-group">
                            <label for="about_us_ar">{{trans('backend.setting.terms_and_conditions')}}</label>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" id="" class="form-control" value="{{$category->translate('en')->name}}">
