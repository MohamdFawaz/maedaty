        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="tocify-content" action="{{route('backend.shop_branch.update',$shop_branch->id)}}" method="POST">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input id="address" type="text" name="address" class="form-control" value="{{$shop_branch->address}}">
