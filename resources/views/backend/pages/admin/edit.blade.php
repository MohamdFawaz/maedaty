        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="tocify-content" action="{{route('backend.admin.update',$user->id)}}" method="POST" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}
                        ...
                        <div class="image-upload friend" >
                            <label for="file-input" class="image-upload-label">
                                <img alt="upload-user-image" src="{{$user->user_image}}" class="thumb" style="width: 300px"/>
                            </label>
