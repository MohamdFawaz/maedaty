        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form class="tocify-content" action="{{route('backend.shop.update',$shop->id)}}" method="POST" enctype="multipart/form-data">
                        {{ method_field('PATCH') }}
                        {{ csrf_field() }}

                        <div class="form-group">
                            <label for="name_ar">{{trans('backend.shop.name_ar')}}</label>
                            <input id="name_ar" type="text" name="name_ar" class="form-control" value="{{$shop->translate('ar')->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description_ar" name="description_ar" class="form-control">{{$shop->translate('ar')->description}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name_en" class="form-control" value="{{$shop->translate('en')->name}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="description_en" name="description_en" class="form-control">{{$shop->translate('en')->description}}</textarea>
                        ...
                        <div class="form-group">
                            <label for="owner">{{trans('backend.shop.owner_name')}}</label>
                                ...
                                <option value="{{$user->id}}" @if($shop->user_id == $user->id) selected @endif>{{$user->full_name}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="image-upload friend" >
                            <label for="file-input" class="image-upload-label">
                                <img alt="image-place-holder" src="{{$shop->image}}" class="thumb" style="width: 300px"/>
                            </label>
