...
<script type="text/javascript" src="{{asset('public/js/plugins/morris/raphael-min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/js/plugins/morris/morris.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/js/plugins/rickshaw/d3.v3.js')}}"></script>
<script type="text/javascript" src="{{asset('public/js/plugins/rickshaw/rickshaw.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('public/js/plugins/owl/owl.carousel.min.js') }}"></script>

<script type="text/javascript" src="{{asset('public/js/plugins/moment.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/js/plugins/daterangepicker/daterangepicker.js')}}"></script>
