...
Route::group(['prefix' => 'user'], function (){
    ...
    Route::get('/address/{user_id}', 'api\AddressController@show')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );
...
Route::group(['prefix' => 'user'], function (){
    ...
    Route::get('cart/{user_id}','api\CartController@index')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );
...
Route::group(['prefix' => 'order'], function (){
    ...
    Route::get('/user/{user_id}', 'api\OrderController@orderInfo')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );

    Route::get('/user/list/{user_id}', 'api\OrderController@listOrder')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );

    Route::get('/{order_id}', 'api\OrderController@listOrderProducts')->where(
        [
            'order_id' => '[0-9]+'
        ]
    );
...
Route::group(['prefix' => 'user'], function (){
    ...
    Route::get('/profile/{user_id}', 'api\ProfileController@show')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );
...
Route::group(['prefix' => 'product'], function (){
    ...
    Route::get('/offers/{user_id?}', 'api\ProductController@hotOffers')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );

    Route::get('/shop/{shop_id}/{category_id}/{subcategory_id?}/{user_id?}', 'api\ProductController@getShopProducts')->where(
        [
            'shop_id' => '[0-9]+',
            'category_id' => '[0-9]+',
            'subcategory_id' => '[0-9]+',
    ...
    Route::get('/search', 'api\ProductController@searchForProducts')->where(
        [
            'user_id' => '[0-9]+'
        ]
    );
...
Route::group(['prefix' => 'shop'], function (){
    ...
    Route::get('/branch/{shop_id}', 'api\ShopController@shopBranches')->where(
        [
            'shop_id' => '[0-9]+'
        ]
    );

    Route::get('/categories/{shop_id}', 'api\ShopController@getShopCategories')->where(
        [
            'shop_id' => '[0-9]+'
        ]
    );
