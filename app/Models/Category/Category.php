...
class Category extends Model
{
    ...
    public function getActionAttribute()
    {
        ...
        $action .= '<a href="#" class="mb-control delete-category-btn" data-name="'.$this->name.'" data-id="'.$this->id.'"> <button  class="btn btn-danger btn-condensed " ">'.trans("backend.action.delete").'</button></a>';
